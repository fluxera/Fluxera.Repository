namespace Fluxera.Repository.Caching
{
	...
	[UsedImplicitly]
	internal sealed class TimeoutCachingStrategy<TEntity, TKey> : ICachingStrategy<TEntity, TKey>
		...
		where TKey : IComparable<TKey>, IEquatable<TKey>
	{
		...
		/// <inheritdoc />
		public async Task<TResult> GetAsync<TResult>(TKey id, Expression<Func<TEntity, TResult>> selector, Func<Task<TResult>> setter)
		{
			try
			{
		...
		/// <inheritdoc />
		public async Task<TEntity> FindOneAsync(Expression<Func<TEntity, bool>> predicate, IQueryOptions<TEntity> queryOptions, Func<Task<TEntity>> setter)
		{
			try
			{
				long generation = GetGenerationAsync();
		...
		/// <inheritdoc />
		public async Task<TResult> FindOneAsync<TResult>(Expression<Func<TEntity, bool>> predicate, Expression<Func<TEntity, TResult>> selector, IQueryOptions<TEntity> queryOptions, Func<Task<TResult>> setter)
		{
			try
			{
				long generation = GetGenerationAsync();
		...
		/// <inheritdoc />
		public async Task<IReadOnlyCollection<TEntity>> FindManyAsync(Expression<Func<TEntity, bool>> predicate, IQueryOptions<TEntity> queryOptions, Func<Task<IReadOnlyCollection<TEntity>>> setter)
		{
			try
			{
				long generation = GetGenerationAsync();
		...
		/// <inheritdoc />
		public async Task<IReadOnlyCollection<TResult>> FindManyAsync<TResult>(Expression<Func<TEntity, bool>> predicate, Expression<Func<TEntity, TResult>> selector, IQueryOptions<TEntity> queryOptions, Func<Task<IReadOnlyCollection<TResult>>> setter)
		{
			try
			{
				long generation = GetGenerationAsync();
